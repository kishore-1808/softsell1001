      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              The easiest way to sell your unused software licenses and recoup your investment.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <a href="mailto:support@softsell.com" className="text-gray-400 hover:text-white transition-colors">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0">
            <p className="text-gray-400 text-sm">
              Secure payments by <span className="font-medium">Stripe</span> | <span className="font-medium">PayPal</span> | <span className="font-medium">Wise</span>
            </p>
          </div>
        </div>
      </div>
